...
class MainWindow(QWidget):
    ...
    def _connect_to_db(self):
        self.conn = psycopg2.connect(database="schendule",
                                     user="postgres",
                                     password='pyesnk1312ilovq',
                                     host="localhost",
                                     port="5432")
    ...
    def _update_subject_table(self):
        ...
        for i, r in enumerate(records):
            r = list(r)
            id = r[0]
            join_button = QPushButton("Update")
    ...
    def _create_monday_table(self):
        ...
        self.monday_table.setHorizontalHeaderLabels(["Subject", "Room number", "Day", "Time", "", ""])
    ...
    def _create_tuesday_table(self):
        ...
        self.tuesday_table.setHorizontalHeaderLabels(["Subject", "Room number", "Day", "Time", "", ""])
    ...
    def _create_wednesday_table(self):
        ...
        self.wednesday_table.setHorizontalHeaderLabels(["Subject", "Room number", "Day", "Time", "", ""])
    ...
    def _create_thursday_table(self):
        ...
        self.thursday_table.setHorizontalHeaderLabels(["Subject", "Room number", "Day", "Time", "", ""])
    ...
    def _create_friday_table(self):
        ...
        self.friday_table.setHorizontalHeaderLabels(["Subject", "Room number", "Day", "Time", "", ""])
    ...
    def _create_saturday_table(self):
        ...
        self.saturday_table.setHorizontalHeaderLabels(["Subject", "Room number", "Day", "Time", "", ""])
    ...
    def _update_table(self, table, st):
        self.cursor.execute(f"SELECT * FROM timetable WHERE day='{st}' order by week, class_time ")
        records = list(self.cursor.fetchall())
    ...
    def _change_day_from_table(self, num, id_n, table):
        ...
        try:
            self.cursor.execute(
                f"UPDATE timetable set room_number = '{row[1]}', day= '{row[2]}', subject = '{row[0]}', class_time='{row[3]}' where id = {id_n}")
            self.conn.commit()
        except Exception:
            QMessageBox.about(self, "Error", "Enter all fields")
    ...
    def _set_day_to_table(self, num, st, table):
        ...
        try:
            self.cursor.execute(
                f"insert into timetable (class_time, week, subject, day, room_number) values( '{row[3]}','{row[2]}','{row[0]}', '{st}', '{row[1]}')")
            self.conn.commit()
        except Exception:
            QMessageBox.about(self, "Error", "Cant insert row")
